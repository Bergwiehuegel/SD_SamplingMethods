...
class UniPC:
    def __init__(self, num_train_timesteps=1000, img_size=32, device="cuda", n=10, run_id="test_run_unipc", solver_order=3): # solver order 3 for unconditional sampling
...
if __name__ == '__main__':
    ...
    sampler = UniPC(img_size=32, device=device)
